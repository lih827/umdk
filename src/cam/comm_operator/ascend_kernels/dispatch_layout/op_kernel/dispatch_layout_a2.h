 ...
 * Description: dispatch layout a2 function device header file
 * Create: 2026-01-09
 * Note:
 * History: 2026-01-09 create dispatch layout a2 header file in device part
 */
...
using namespace Moe;
template <typename T> class DispatchLayoutA2 {
  public:
