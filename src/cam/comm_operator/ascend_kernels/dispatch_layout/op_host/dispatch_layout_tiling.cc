                                               ...
                                               DispatchLayoutTilingData &tilingData)
{
    ...
    OPS_CHECK(localRankSizePtr == nullptr, OPS_LOG_E(nodeName, "localRankSizePtr is null."), return ge::GRAPH_FAILED);
    ...
    if (CheckIfA2Machine(context)) {
        OPS_CHECK((*localRankSizePtr <= 0) || (*localRankSizePtr > MAX_LOCAL_RANKSIZE),
